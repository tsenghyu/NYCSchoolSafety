...
```{r}
# get the data
NYC_school <- read.csv(file = '/Users/tomyu/Desktop/Columbia/Columbia First Yr #1 semester/2010_-_2016_School_Safety_Report.csv')
